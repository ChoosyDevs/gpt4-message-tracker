...
function checkAndReset() {
    ...
    console.log("Seconds till reset:", (windowDuration - (Date.now() - localStorage.getItem('first_message_timestamp'))) / 1000);
   
    if (Date.now() - localStorage.getItem('first_message_timestamp') > windowDuration) {
